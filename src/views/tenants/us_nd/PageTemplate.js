        ...
        <div id="importantNotes" className="collapse" aria-labelledby="importantNotesBarHeading"
          ...
          <div className="bdT mT-10 pT-10">
            <p>
              ...
              admitted to prison because of a revocation. If an individual has multiple cases terminated differently (ie
              one expires and one ends via revocation) an individual will be counted towards all numbers for which at
              least one case is relevant (in that case, the individual would count towards successful terminations
              because of the expired case, and towards revocations because of the revoked case).
            </p>
            <p>
              ...
              Individuals sentenced to a DOCR facility but who do not wind up in that facility are not counted (this may
              happen, for example, if they serve significant time in a county jail prior to being returned to prison).
              Individuals who are booked with an admission reason of new admission are not counted as revocations, even
              if a recent supervision sentence ended with a revocation with a sentence to DOCR facility disposition.
            </p>
            <p>
